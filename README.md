...
- **Private keys never leave your device** - Stored only in session memory, never persisted
...
- ✅ Encrypted file storage in MongoDB
...
│   │       ├── users.js           # GET/POST /users/public-key
│   │       └── files.js           # POST /files/send, GET /files/inbox
│   │
│   └── package.json
│
...
#### `GET /users/public-key?email=user@example.com`
