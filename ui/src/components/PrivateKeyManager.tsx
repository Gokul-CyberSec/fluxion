  ...
  return (
    <div className="glass-card p-8 rounded-3xl max-w-2xl mx-auto">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold mb-2">Load Private Key</h2>
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="relative">
            ...
            />
            <div className="border-2 border-dashed border-muted-foreground/20 rounded-2xl p-6 text-center hover:border-primary/50 hover:bg-primary/5 transition-all cursor-pointer group">
        ...
        <div>
          ...
          <Textarea
            ...
            rows={8}
            className="font-mono text-xs rounded-xl bg-muted/50 border-0 focus:ring-2 focus:ring-primary/50"
          />
        </div>

        {error && (
          <div className="flex items-start gap-2 text-sm text-destructive bg-destructive/10 p-4 rounded-xl">
